...
{
    public class EstudianteFormularioDTO
    {
        ...
        [Required(
            ErrorMessage =
                "Debe seleccionar un tipo de beneficiario.")]
        [Range(
            1,
            int.MaxValue,
            ErrorMessage =
        ...
        [Range(
            ...
            2100,
            ErrorMessage =
                "El año de ingreso no es válido.")]
        [Display(Name = "Año de ingreso")]
        public short AnioIngreso { get; set; }

        public bool Activo { get; set; } = true;

        public List<CatalogoDTO> TiposBeneficiario
        {
            get;
            set;
        } = new();

        public List<CatalogoDTO> GradosSecciones
        {
            get;
            set;
        } = new();
